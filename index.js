// sory coach untuk kali ini bisa dibilang full bantuan AI
// yg sy ganti cuman "todos.length === null" tadinya "todos.length === 0"
// again coach, utk build dari startnya masih belum paham logicnya
// tapi utk baca alurnya setelah jadi masih bisa namun kali ini 70-80% bisa
// krn jujur masih ngulang pemahaman materi lg dan baru entry di materi-10
// silahkan coach menilai apa adanya ya, sy aman dan siap menerima
// agar sy tau pemahaman sy sampai mana atau parameter lvl pemahaman sy baru di dmn
// bagian yg sy masih kurang paham adl:
// - function generateUniqueId()
// - splice(num - 1, 1)[0] di function deleteTodo()
// - todos.length === ini yg benar isinya 0 or null 
...
function markTodoCompleted() {
  ...
  if (target.isCompleted) {
    console.log(`"${target.text}" is already completed.`);
    return;
  }

  target.isCompleted = true;
  console.log(`To-do "${target.text}" marked as completed.`);
}
...
function deleteTodo() {
  ...
  const num = Number(prompt("Enter the NUMBER of the to-do to delete: "));
...
Choose an option:
1. Add To-Do
2. Mark To-Do Completed
3. Delete To-Do
4. List To-Dos
5. Exit
        `);

    const command = prompt("Enter command number: ");
